  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <div className="w-20 h-20 md:w-28 md:h-28 rounded-2xl flex items-center justify-center transition-all duration-500 md:group-hover:scale-105 md:group-hover:shadow-lg md:group-hover:shadow-gold/10"
        style={{
          background: 'linear-gradient(135deg, rgba(184,115,51,0.12), rgba(217,160,102,0.04))',
...
function BetaBadge() {
  return (
    <div className="relative px-3 py-1 rounded-full overflow-hidden"
      style={{
        background: 'linear-gradient(135deg, rgba(184,115,51,0.2), rgba(217,160,102,0.1))',
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: '0 0 40px rgba(184,115,51,0.02), inset 0 1px 0 rgba(184,115,51,0.06)',
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            boxShadow: '0 0 80px rgba(184,115,51,0.08), 0 20px 60px rgba(0,0,0,0.5), inset 0 1px 0 rgba(184,115,51,0.12)',
          }}
        />
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(800px circle at 50% 50%, rgba(184,115,51,0.04), transparent 60%)',
          }}
        />
        ...
        <div className="flex flex-col md:flex-row min-h-[400px] md:min-h-[340px]">
          <div className="relative w-full md:w-[40%] flex items-center justify-center p-8 md:p-10 min-h-[220px] md:min-h-0">
            <div className="absolute inset-3 md:inset-4 rounded-xl pointer-events-none"
              style={{ border: '1px solid rgba(184,115,51,0.06)' }}
            />
            <div className="absolute top-5 left-5 w-3 h-3 pointer-events-none"
              style={{ borderTop: '1.5px solid rgba(184,115,51,0.12)', borderLeft: '1.5px solid rgba(184,115,51,0.12)' }}
            />
            <div className="absolute top-5 right-5 w-3 h-3 pointer-events-none"
              style={{ borderTop: '1.5px solid rgba(184,115,51,0.12)', borderRight: '1.5px solid rgba(184,115,51,0.12)' }}
            />
            <div className="absolute bottom-5 left-5 w-3 h-3 pointer-events-none"
              style={{ borderBottom: '1.5px solid rgba(184,115,51,0.12)', borderLeft: '1.5px solid rgba(184,115,51,0.12)' }}
            />
            <div className="absolute bottom-5 right-5 w-3 h-3 pointer-events-none"
              style={{ borderBottom: '1.5px solid rgba(184,115,51,0.12)', borderRight: '1.5px solid rgba(184,115,51,0.12)' }}
            />
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div
                ...
                style={{ background: 'radial-gradient(circle, rgba(184,115,51,0.08) 0%, transparent 60%)' }}
              />
            </div>
            ...
            <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  {project.tags.map((tag) => (
                    <span key={tag}
                      ...
                      style={{ border: '1px solid rgba(184,115,51,0.2)', background: 'rgba(184,115,51,0.06)', color: 'rgba(184,115,51,0.6)' }}
                    >
                      {tag}
                    </span>
                  ))}
              ...
              >
                ...
                <a
                  ...
                  className="group/btn inline-flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-400 md:hover:bg-gold/12 md:hover:shadow-[0_0_25px_rgba(184,115,51,0.1)]"
                  style={{ border: '1px solid rgba(184,115,51,0.25)', color: 'rgba(184,115,51,0.85)' }}
                >
...
export default function Showcase() {
  ...
  return (
    <section ref={sectionRef} id="showcase" className="section-padding relative overflow-hidden"
      style={{ background: 'linear-gradient(180deg, #101010 0%, #0a0804 50%, #101010 100%)' }}
    >
      <div ref={bgRef} className="absolute inset-0 pointer-events-none will-change-transform">
        <Suspense fallback={null}>
          <Scene3D cameraPosition={[0, 0, 10]} frameloop="demand" dpr={[1, 1.2]}>
            <FloatingShape geometry="icosahedron" color="#B87333" scale={1.8} speed={0.04} floatAmplitude={0.5} mouseInfluence={0.15} />
            <FloatingShape geometry="torusKnot" color="#D9A066" scale={0.8} speed={0.08} floatAmplitude={0.6} mouseInfluence={0.2} />
            <Particles3D count={40} color="#B87333" size={0.02} speed={0.04} spread={15} />
          </Scene3D>
        </Suspense>
      </div>
