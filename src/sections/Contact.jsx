              ...
              >
                ...
                <div className="mb-6 pb-6 border-b border-border/30">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        name="date"
                        className="w-full bg-white/5 border border-border/40 rounded-lg px-4 py-3 font-body text-sm text-white/80 focus:outline-none focus:border-gold/60 transition-colors"
                      >
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-border/40 rounded-lg px-4 py-3 font-body text-sm text-white placeholder:text-muted/50 focus:outline-none focus:border-gold/60 transition-colors"
                    />
                  </div>
                  <div>
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/5 border border-border/40 rounded-lg px-4 py-3 font-body text-sm text-white placeholder:text-muted/50 focus:outline-none focus:border-gold/60 transition-colors resize-none"
                  />
                </div>
                <MagneticButton
