    ...
    <div className="relative flex items-center justify-center">
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[400px] rounded-xl blur-[3px]
                        ...
                        before:bg-[conic-gradient(#000,#D4AF37_5%,#000_38%,#000_50%,#F2D27A_60%,#000_87%)] before:transition-all before:duration-2000
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[398px] rounded-xl blur-[3px]
                        ...
                        before:bg-[conic-gradient(rgba(0,0,0,0),#1a1508,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,#4a3a15,rgba(0,0,0,0)_60%)] before:transition-all before:duration-2000
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[393px] rounded-lg blur-[2px]
                        ...
                        before:bg-[conic-gradient(rgba(0,0,0,0)_0%,#D4AF37,rgba(0,0,0,0)_8%,rgba(0,0,0,0)_50%,#F2D27A,rgba(0,0,0,0)_58%)] before:brightness-140
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[389px] rounded-xl blur-[0.5px]
                        ...
                        before:bg-[conic-gradient(#050505,#D4AF37_5%,#050505_14%,#050505_50%,#F2D27A_60%,#050505_64%)] before:brightness-130
        ...
        <div className="relative">
          <input
            ...
            type="text"
            name="text"
            className="bg-[#050505] border-none w-[387px] h-[56px] rounded-lg text-white px-[59px] text-lg focus:outline-none placeholder-gold/30"
          />
          <div className="pointer-events-none w-[100px] h-[20px] absolute bg-gradient-to-r from-transparent to-[#050505] top-[18px] left-[70px] group-focus-within:hidden"></div>
          ...
          <div className="absolute h-[42px] w-[40px] overflow-hidden top-[7px] right-[7px] rounded-lg
                          ...
                          before:bg-[conic-gradient(rgba(0,0,0,0),#4a3a15,rgba(0,0,0,0)_50%,rgba(0,0,0,0)_50%,#4a3a15,rgba(0,0,0,0)_100%)]
                          before:brightness-135 before:animate-spin-slow">
          </div>
          <button
            onClick={() => results.length > 0 && navigate(results[selectedIdx >= 0 ? selectedIdx : 0].id)}
            className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-[#1a1508] via-black to-[#2a2010] border border-transparent cursor-pointer hover:from-[#2a2010] hover:to-[#1a1508] transition-all duration-300"
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" height="24" fill="none">
              ...
              <defs>
                <linearGradient gradientTransform="rotate(50)" id="search">
                  <stop stopColor="#F2D27A" offset="0%"></stop>
                  <stop stopColor="#D4AF37" offset="50%"></stop>
                </linearGradient>
                <linearGradient id="searchl">
                  <stop stopColor="#D4AF37" offset="0%"></stop>
                  <stop stopColor="#8a7322" offset="50%"></stop>
                </linearGradient>
              </defs>
            </svg>
          </div>
              ...
              {results.map((r, i) => (
                <button
                  ...
                  style={{
                    ...
                    color: i === selectedIdx ? '#D4AF37' : 'rgba(245,245,245,0.5)',
                  }}
                >
