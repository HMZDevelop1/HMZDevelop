...
const shapes = [
  { geometry: 'torus', color: '#DC2626', radius: 2.5, speed: 0.3, size: 0.5, phase: 0 },
  { geometry: 'icosahedron', color: '#EF4444', radius: 3.2, speed: -0.25, size: 0.4, phase: 1.2 },
  { geometry: 'octahedron', color: '#DC2626', radius: 1.8, speed: 0.4, size: 0.35, phase: 2.5 },
