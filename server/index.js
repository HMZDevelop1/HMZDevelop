    ...
    try {
      ...
      if (resend) {
        ...
        <div style="font-family: system-ui; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #DC2626; border-bottom: 2px solid #DC2626; padding-bottom: 12px;">
            ✦ New Inquiry — HMZDevelop
          </h2>

          ${date && time ? `
          <div style="background: #f5ede4; border: 1px solid #DC2626; border-radius: 8px; padding: 16px; margin: 16px 0;">
          ...
          <p style="color: #aaa; font-size: 12px;">
            ID: ${entry.id} &middot;
            <a href="${process.env.SITE_URL || 'http://localhost:5173'}/admin" style="color: #DC2626;">View in dashboard</a>
          </p>
        </div>
      `
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .message-body .booking strong { color: #DC2626; }
    .empty {
      text-align: center;
      padding: 64px 32px;
      color: #666;
