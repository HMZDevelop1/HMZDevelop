    ...
    try {
      ...
      const emailBody = `
        <div style="font-family: system-ui; max-width: 600px; margin: 0 auto;">
          ...
          ${date && time ? `
          <div style="background: #fef9e7; border: 1px solid #D4AF37; border-radius: 8px; padding: 16px; margin: 16px 0;">
          ...
          <p style="color: #aaa; font-size: 12px;">
            ID: ${entry.id} &middot;
            <a href="${process.env.SITE_URL || 'http://localhost:5173'}/admin" style="color: #D4AF37;">View in dashboard</a>
          </p>
        </div>
      `
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .message-body .booking strong { color: #D4AF37; }
    .empty {
      text-align: center;
      padding: 64px 32px;
      color: #666;
